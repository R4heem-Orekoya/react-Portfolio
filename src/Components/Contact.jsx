        ...
        <section className="text-white" id="contact">
            <div className="max-w-[1000px] w-[90%] mx-auto py-[100px]">
                ...
                <form action="#" className="max-w-[500px] w-[90%] mx-auto mt-12 flex-col justify-center gap-4">
                    <input className="w-[100%] h-[60px] md:h-[50px] border-none outline-none mb-4 px-3 bg-transparent ring-2 ring-blue-600 rounded-md" type="text" placeholder="Your name"/>
                    <input className="w-[100%] h-[60px] md:h-[50px] border-none outline-none mb-4 px-3 bg-transparent ring-2 ring-blue-600 rounded-md" type="email" placeholder="Your email"/>
